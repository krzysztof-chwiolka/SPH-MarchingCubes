...
public class Chunk : MonoBehaviour {
    ...
    [SerializeField] private SPHManager sphManager;
    ...
    public void Start() {
        this.grid = new Grid(this, this.computeShader);
        startingScale = transform.localScale;
    }

    public void Update() {
        grid.sphManager = sphManager;
        grid.sphParticlePrefab = sphParticlePrefab;
        grid.evaluateAll();//this.GetComponentsInChildren<MetaBall>());
...
public class UvCalculator
{
    ...
    public static Vector2[] CalculateUVs(Vector3[] verts, float scale)
    {
